...
CARRIAGE_RETURN = 13
BACK_SPACE = 8
; Change to $DE04 when building for a F256 Jr. Rev B using FPGA release RC09 or older
...
; --------------------------------------------------
calcCursorOffset
    #calcMemoryOffset CURSOR_STATE.xPos, CURSOR_STATE.yPos, CURSOR_STATE.videoRamPtr
    rts
