...
HI_SCORE_FILE_NAME .text "hiscore.dat"

HI_SCORE .dstruct FileState_t, 76, HI_SCORE_FILE_NAME, len(HI_SCORE_FILE_NAME), GLOBAL_STATE.highScore, size(PointsBCD_t), MODE_WRITE, DEVICE_NUM

; carry set when error occured
saveHiScore
    stz HI_SCORE.streamId

    lda #size(PointsBCD_t)
    sta HI_SCORE.dataLen
    
    #load16BitImmediate GLOBAL_STATE.highScore, HI_SCORE.dataPtr
    
    lda #MODE_WRITE
    sta HI_SCORE.mode
    
    #load16BitImmediate HI_SCORE, FILEIO_PTR1
