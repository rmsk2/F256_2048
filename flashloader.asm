...
.text "f256_2048"                          ; name of the program used for starting
.byte $00                                  ; zero termination for "snake"
.byte $00                                  ; zero termination for parameter description
.text "A 2048 clone"                       ; Comment shown in lsf
...
BLOCK1 .dstruct BlockSpec_t, $83 - 64, 0, 3, 32  ; copy flash block $42 (block number $83) to RAM block 0. Start at offset $0300
BLOCK2 .dstruct BlockSpec_t, $84 - 64, 1, 0, 32  ; copy flash block $43 (block number $84) to RAM block 1. Start at offset $0000
BLOCK3 .dstruct BlockSpec_t, $85 - 64, $10, 0, 32  ; copy flash block $44 (block number $85) to RAM block 16. Start at offset $0000
BLOCK4 .dstruct BlockSpec_t, $86 - 64, $11, 0, 32  ; copy flash block $45 (block number $86) to RAM block 17. Start at offset $0000
